...
namespace
{
                       ...
                       const char* label)
    {
        ...
        const std::string j1 = original.toJson().dump(4);

        MetaUnit restored = MetaUnit::fromJson(j1);

        const std::string j2 = restored.toJson().dump(4);
...
int main(int argc, char* argv[])
{
    ...
    roundtrip_one(test_file_dir / "test_header2.hpp",         include_root, "dynamic_reflection",  "test_header2");
