...
namespace lux::cxx::dref
{
	...
	ParseResult CxxParserImpl::parse(std::string_view file, const std::vector<std::string>& commands, std::string_view name, std::string_view version)
	{
		auto translate_unit = translate(file, commands);
