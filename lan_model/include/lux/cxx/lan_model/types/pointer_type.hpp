...
namespace lux::cxx::lan_model
{
	struct PointerType : public Compound { static constexpr ETypeKind kind = ETypeKind::POINTER; };
		struct ObjectPointerType : public PointerType { static constexpr ETypeKind kind = ETypeKind::POINTER_TO_OBJECT; Type* pointee_type; };
		struct FunctionPointerType : public PointerType { static constexpr ETypeKind kind = ETypeKind::POINTER_TO_FUNCTION; FunctionType* pointee_type; };
