...
namespace lux::cxx::reflection
{
    ...
    // ---------------------------------------------------------------
    #define LUX_REFLECT_DECL_KIND_TABLE(X)                                   \
    ...
    inline std::string declKindToString(EDeclKind k)
    {
        switch (k)
        {
        #define LUX_REFLECT_X(enumerator, str) case EDeclKind::enumerator: return str;
            LUX_REFLECT_DECL_KIND_TABLE(LUX_REFLECT_X)
        #undef LUX_REFLECT_X
        default:
            return "UnknownDecl";
        }
    ...
    {
        #define LUX_REFLECT_X(enumerator, str) if (s == str) return EDeclKind::enumerator;
            LUX_REFLECT_DECL_KIND_TABLE(LUX_REFLECT_X)
        #undef LUX_REFLECT_X
    ...
    inline bool isNamedDeclKind(EDeclKind k)
    {
        switch (k)
        {
        #define LUX_REFLECT_X(enumerator, str) case EDeclKind::enumerator: return true;
            LUX_REFLECT_DECL_KIND_TABLE(LUX_REFLECT_X)
        #undef LUX_REFLECT_X
        default:
            return false;
    ...
    // ---------------------------------------------------------------
    #define LUX_REFLECT_TYPE_KIND_TABLE(X)                                       \
    ...
    inline std::string typeKindToString(ETypeKinds k)
    {
        switch (k)
        {
        #define LUX_REFLECT_X(enumerator, str) case ETypeKinds::enumerator: return str;
            LUX_REFLECT_TYPE_KIND_TABLE(LUX_REFLECT_X)
        #undef LUX_REFLECT_X
        default:
    ...
    {
        #define LUX_REFLECT_X(enumerator, str) if (s == str) return ETypeKinds::enumerator;
            LUX_REFLECT_TYPE_KIND_TABLE(LUX_REFLECT_X)
        #undef LUX_REFLECT_X
    ...
    // ---------------------------------------------------------------
    #define LUX_REFLECT_TAG_KIND_TABLE(X)                                        \
        X(Struct, "Struct")                                                   \
        X(Class,  "Class")                                                    \
        X(Union,  "Union")                                                    \
        X(Enum,   "Enum")
    ...
    inline std::string tagKindToString(TagDecl::ETagKind k)
    {
        switch (k)
        {
        #define LUX_REFLECT_X(enumerator, str) case TagDecl::ETagKind::enumerator: return str;
            LUX_REFLECT_TAG_KIND_TABLE(LUX_REFLECT_X)
        #undef LUX_REFLECT_X
        }
        return "Struct";
    }
    ...
    {
        #define LUX_REFLECT_X(enumerator, str) if (s == str) return TagDecl::ETagKind::enumerator;
            LUX_REFLECT_TAG_KIND_TABLE(LUX_REFLECT_X)
        #undef LUX_REFLECT_X
