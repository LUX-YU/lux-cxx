...
int main(int argc, char* argv[])
{
    ...
    std::filesystem::path reflection_project_dir = test_file_dir.parent_path();
    ...
    auto json = meta.toJson(4);
    auto meta_json_str = json;
    ...
    // Round-trip serialization test
    {
        ...
        auto reserialized = deserialized.toJson(4);
