...
struct LUX_META(static_reflection;lux_reflection) TestClass
{
...
enum class LUX_META(static_reflection;lux_reflection) TestEnum
{
...
namespace lux::cxx::reflection::test
{
    ...
    static inline int LUX_META(lux_reflection) func()
    {
        return 0;
    }

	static inline int LUX_META(lux_reflection) func(int a)
	{
		return a;
	}
}